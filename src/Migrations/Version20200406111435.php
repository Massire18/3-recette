 ...
 */
final class Version20200406111435 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE aliment ADD type_id INT DEFAULT NULL, CHANGE updated_at updated_at DATE NOT NULL');
